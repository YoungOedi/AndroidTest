...
public class HomeScreenActivity extends AppCompatActivity {
    ...
    @Inject
    HomeScreenPresenter mHomePresenter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        HomeScreenFragment homeFragment = (HomeScreenFragment) getSupportFragmentManager()
                .findFragmentById(R.id.fragment_home_screen);
        if(homeFragment==null) {
            homeFragment = HomeScreenFragment.newInstance();
            FragmentTransaction transaction = getSupportFragmentManager().beginTransaction();
            transaction.add(R.id.fragment_home_screen, homeFragment).commit();
        }
